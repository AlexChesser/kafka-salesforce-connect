 ...
 */
package com.github.jcustenborder.kafka.connect.salesforce.common;
...
public class TopicChannelMessageListener implements ClientSessionChannel.MessageListener {
  ...
  public TopicChannelMessageListener(SourceRecordConcurrentLinkedDeque records, SalesforceSourceConnectorConfig config, Schema keySchema, Schema valueSchema) {
